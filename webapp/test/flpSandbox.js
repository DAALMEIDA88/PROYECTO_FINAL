		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#logaligrouplogalifinal2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligrouplogalifinal2-display": {
								"semanticObject": "logaligrouplogalifinal2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.logalifinal2",
									"url": sap.ui.require.toUrl("logaligroup/logalifinal2")
								}
							}
						}
					}
